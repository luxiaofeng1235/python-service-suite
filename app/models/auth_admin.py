...
class AuthAdmin(Base):
    ...
    mobile = Column(String(20), nullable=True, default="", comment="手机号")
    email = Column(String(255), nullable=True, default="", comment="邮箱")
    sex = Column(Integer, nullable=True, default=0, comment="性别 0=保密 1=男 2=女")
